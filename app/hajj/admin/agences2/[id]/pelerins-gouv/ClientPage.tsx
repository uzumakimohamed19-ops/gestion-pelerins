...
export default function AgencePelerinsGouvPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto p-6 space-y-6">
      ...
      {/* Bouton Retour */}
      <Link
        href={`/hajj/admin/agences2/detail?id=${agenceId}`}
                  ...
                  <tr key={pelerin.id} className="hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="p-4 text-center">
                      <div className="flex items-center justify-center gap-2 flex-wrap">
                        ...
                        <Link
                          href={`/hajj/admin/agences2/pelerins-gouv/profil?agenceId=${agenceId}&pelerinId=${pelerin.id}`}
