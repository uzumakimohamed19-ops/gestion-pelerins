    ...
    <body>
      ...
      <div class="no-print" style="position:fixed;bottom:24px;right:24px;display:flex;gap:10px;z-index:999;">
        ...
        <button
          ...
          style="background:#f1f5f9;color:#475569;border:1px solid #e2e8f0;padding:12px 18px;border-radius:12px;font-size:13px;font-weight:700;cursor:pointer;display:flex;align-items:center;gap:8px;"
        >
          ✕ Fermer
        </button>
      </div>
